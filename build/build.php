...
<div 
    id="resume"
    class="flex flex-col h-screen hidden mt-5" 
>
    <div 
        id="resumeWrapper" 
        class="bg-grey-700 flex items-center h-auto flex-wrap
    ...
    <main 
    id="profile" 
    class="w-full shadow-2xl bg-gray-900 opacity-75
        lg:mx-6
        mx-0"
    >
        <div class="relative top-0 right-0 h-12 w-18 p-4 flex flex-row justify-between">
            <button id="themeChanger" class="focus:outline-none">☀️</button>
            <button id="togglePageButtonWork" class="focus:outline-none">
